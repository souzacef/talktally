...
const enUS = {
  ...
  'dashboard.story': 'Here is the story your money is telling.',
  'dashboard.voiceFirstCapture': 'Voice-first capture',
  'dashboard.whatHappened': 'What happened today?',
  'dashboard.voiceDescription': 'Speak naturally. TalkTally sends a real WAV command to your secured assistant.',
  'dashboard.heard': 'Heard: {transcript}',
  'dashboard.voiceReplyUnavailable': 'Voice reply unavailable — result still succeeded.',
  ...
  'dashboard.netCashFlowNote': 'Calculated by TalkTally on the server',
  'dashboard.monthlyCashFlow': 'Monthly cash flow',
  'dashboard.monthlyCashFlowDescription': 'Backend-reported income and expenses across the last six calendar months.',
  ...
  'dashboard.recentActivityDescription': 'Latest server-owned financial records',
...
const ptBR: Record<MessageKey, string> = {
  ...
  'dashboard.story': 'Veja a história que o seu dinheiro está contando.',
  'dashboard.voiceFirstCapture': 'Registro por voz',
  'dashboard.whatHappened': 'O que aconteceu hoje?',
  'dashboard.voiceDescription': 'Fale naturalmente. O TalkTally envia um comando WAV real ao seu assistente protegido.',
  ...
  'dashboard.netCashFlowNote': 'Calculado pelo TalkTally no servidor',
  'dashboard.monthlyCashFlow': 'Fluxo de caixa mensal',
  'dashboard.monthlyCashFlowDescription': 'Renda e despesas informadas pelo backend nos últimos seis meses do calendário.',
  ...
  'dashboard.recentActivityDescription': 'Registros financeiros mais recentes do servidor',
